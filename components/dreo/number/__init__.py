...
from .. import CONF_DREO_ID, Dreo, DreoDatapointType, dreo_ns
...
DATAPOINT_TYPES = {
    "int": DreoDatapointType.INTEGER,
    "uint": DreoDatapointType.INTEGER,
    "enum": DreoDatapointType.ENUM,
}
...
CONFIG_SCHEMA = cv.All(
    number.number_schema(DreoNumber)
    .extend(
        {
